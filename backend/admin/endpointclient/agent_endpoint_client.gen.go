// Package agentendpointclient provides primitives to interact with the openapi HTTP API.
//
// Code generated by github.com/deepmap/oapi-codegen/v2 version v2.0.0 DO NOT EDIT.
package agentendpointclient
...
func NewGetDiagnosticsRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v2/diagnostics")
	if operationPath[0] == '/' {
