...
func NewNamespaceIdentifier(kind NamespaceKind, identifier identifierImpl) identifierWithKind[NamespaceKind] {
...
func NewResourceIdentifier(kind ResourceKind, identifier identifierImpl) identifierWithKind[ResourceKind] {
