...
oapi-codegen.exe --package agentclient -generate "types,client" -import-mapping="oapi-base.yaml:github.com/stephenzsy/small-kms/backend/base,oapi-key.yaml:github.com/stephenzsy/small-kms/backend/key,oapi-cert.yaml:github.com/stephenzsy/small-kms/backend/cert/v2" -include-tags agentclient ./oapi-api-agentclient.yaml > agent/client/agent_client.gen.go
