...
oapi-codegen --package managedapp -generate "types,echo-server" -import-mapping="oapi-base.yaml:github.com/stephenzsy/small-kms/backend/base,oapi-profile.yaml:github.com/stephenzsy/small-kms/backend/profile,oapi-freeradius-config.yaml:github.com/stephenzsy/small-kms/backend/agent/radius" ./oapi-managed-app.yaml > managedapp/managed_app.gen.go
