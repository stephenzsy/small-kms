...
oapi-codegen.exe --package agentclient -generate "types,client" -import-mapping="oapi-base.yaml:github.com/stephenzsy/small-kms/backend/base,oapi-key.yaml:github.com/stephenzsy/small-kms/backend/key" -include-tags agentclient ./oapi-cert.yaml > agent/client/agent_client.gen.go
