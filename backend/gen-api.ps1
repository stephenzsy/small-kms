...
oapi-codegen.exe --package agentproxyclient -generate "types,client" -import-mapping="oapi-base.yaml:github.com/stephenzsy/small-kms/backend/base" -include-tags agentproxy ./oapi-client-agentproxy.yaml > agent/proxyclient/agent_proxy_client.gen.go