...
namespace SmallKms.Client.Models {
    public class PolicyRefParameters : ResourceRef, IParsable {
        ...
        public static new PolicyRefParameters CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PolicyRefParameters();
        }
        /// <summary>
