...
using System;
namespace SmallKms.Client.V2.Item.CertificateTemplates.Item.Enroll {
    /// <summary>
    /// Builds and executes requests for operations under \v2\{namespaceId}\certificate-templates\{templateId}\enroll
    /// </summary>
    public class EnrollRequestBuilder : BaseCliRequestBuilder {
        ...
        public EnrollRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/{namespaceId}/certificate-templates/{templateId}/enroll", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new EnrollRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public EnrollRequestBuilder(string rawUrl) : base("{+baseurl}/v2/{namespaceId}/certificate-templates/{templateId}/enroll", rawUrl) {
        }
        /// <summary>
        /// Put certificate template
        /// </summary>
