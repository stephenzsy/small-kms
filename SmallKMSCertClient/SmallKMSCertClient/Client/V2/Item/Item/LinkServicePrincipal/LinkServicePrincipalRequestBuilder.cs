...
using System;
namespace SmallKms.Client.V2.Item.Item.LinkServicePrincipal {
    /// <summary>
    /// Builds and executes requests for operations under \v2\{namespaceType}\{namespaceId}\link-service-principal
    /// </summary>
    public class LinkServicePrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public LinkServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/link-service-principal", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LinkServicePrincipalRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public LinkServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/link-service-principal", rawUrl) {
        }
        /// <summary>
        /// Link device service principal
        /// </summary>
