...
namespace SmallKms.Client.V2.Item.Item.Certificates.Item.Pending {
    ...
    public class PendingRequestBuilder : BaseCliRequestBuilder {
        ...
        public PendingRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificates/{certId}/pending{?includeCertificate*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PendingRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PendingRequestBuilder(string rawUrl) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificates/{certId}/pending{?includeCertificate*}", rawUrl) {
        }
        /// <summary>
        /// complete certificate enrollment
        /// </summary>
