...
namespace SmallKms.Client.V2.Item.Item.Certificates.Item {
    ...
    public class WithCertItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public WithCertItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificates/{certId}{?includeCertificate*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCertItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public WithCertItemRequestBuilder(string rawUrl) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificates/{certId}{?includeCertificate*}", rawUrl) {
        }
        /// <summary>
        /// Get certificate
        /// </summary>
