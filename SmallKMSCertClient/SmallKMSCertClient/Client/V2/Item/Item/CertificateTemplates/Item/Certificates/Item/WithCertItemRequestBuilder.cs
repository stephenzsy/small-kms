...
using System;
namespace SmallKms.Client.V2.Item.Item.CertificateTemplates.Item.Certificates.Item {
    /// <summary>
    /// Builds and executes requests for operations under \v2\{namespaceType}\{namespaceId}\certificate-templates\{templateId}\certificates\{certId}
    /// </summary>
    public class WithCertItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCertItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/{namespaceType}/{namespaceId}/certificate-templates/{templateId}/certificates/{certId}{?apply*,includeCertificate*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCertItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCertItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v2/{namespaceType}/{namespaceId}/certificate-templates/{templateId}/certificates/{certId}{?apply*,includeCertificate*}", rawUrl) {
        }
        /// <summary>
        /// Get certificate
        /// </summary>
