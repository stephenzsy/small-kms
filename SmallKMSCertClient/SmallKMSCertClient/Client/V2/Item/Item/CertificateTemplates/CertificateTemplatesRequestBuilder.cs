...
namespace SmallKms.Client.V2.Item.Item.CertificateTemplates {
    ...
    public class CertificateTemplatesRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Gets an item from the SmallKms.Client.v2.item.item.certificateTemplates.item collection
        /// </summary>
        ...
        public CertificateTemplatesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificate-templates", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CertificateTemplatesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CertificateTemplatesRequestBuilder(string rawUrl) : base("{+baseurl}/v2/{namespaceType}/{namespaceId}/certificate-templates", rawUrl) {
        }
        /// <summary>
        /// List certificate templates
        /// </summary>
