...
namespace SmallKms.Client.V2.Namespaces.Item {
    ...
    public class WithNamespaceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get namespace info with ms graph";
        ...
        public WithNamespaceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v2/namespaces/{namespaceId}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithNamespaceItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public WithNamespaceItemRequestBuilder(string rawUrl) : base("{+baseurl}/v2/namespaces/{namespaceId}", rawUrl) {
        }
        /// <summary>
        /// Get namespace info with ms graph
        /// </summary>
