...
namespace SmallKms.Client {
    ...
    /// </summary>
    public class SmallKmsClient : BaseRequestBuilder {
        ...
        public SmallKmsClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>()) {
            ...
            if (string.IsNullOrEmpty(RequestAdapter.BaseUrl)) {
                RequestAdapter.BaseUrl = "http://localhost:9000";
            }
