...
namespace SmallKms.Client.V1.Item.Profile {
    ...
    public class ProfileRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get namespace profile";
            var namespaceIdOption = new Option<string>("--namespace-id", description: "AAD directory object ID") {
            };
        ...
        public ProfileRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/v1/{namespaceId}/profile", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProfileRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ProfileRequestBuilder(string rawUrl) : base("{+baseurl}/v1/{namespaceId}/profile", rawUrl) {
        }
        /// <summary>
        /// Get namespace profile
        /// </summary>
